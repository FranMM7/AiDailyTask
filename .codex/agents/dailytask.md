...
- **Log what changed:** append an entry under `## Observations` — `### <ISO8601Z> — codex` (use your own agent name) followed by a short note.
...
> Note: the canonical, cross-agent instructions live in the repo-root [AGENTS.md](../../AGENTS.md),
> which Codex and most other agents read automatically. This file mirrors the Claude subagent layout
> for convenience; keep the two in sync.
