...
export class ExportService {
  ...
  private async render(
    ...
    for (const key of keys) {
      ...
      lines.push("| ID | Title | Status | Category | Severity | Risk | Skills | Recurring | Updated |");
      lines.push("| --- | --- | --- | --- | --- | --- | --- | --- | --- |");
      for (const t of rows) {
        lines.push(
          `| ${t.id} | ${mdEscapeCell(t.title)} | ${t.status} | ${t.category} | ${t.severity} | ${t.risk} | ${mdEscapeCell(t.skills.join(", "))} | ${t.recurring ? "Yes" : ""} | ${(t.updated ?? t.created ?? t.updatedEffective).slice(0, 10)} |`,
        );
      }
      lines.push("");
