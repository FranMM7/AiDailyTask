...
reporting success. Streamable HTTP returns 404 for a supplied expired session id so compliant
clients initialize again; a missing required id remains 400. If the host still loops after 404,
